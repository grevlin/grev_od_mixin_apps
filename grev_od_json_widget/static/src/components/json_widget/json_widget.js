 ...
 */
export class JsonSyncWidget extends Component {
    static template = "web.JsonSyncWidget";
...
/**
 * Field definition for JsonSyncWidget.
 */
export const jsonField = {
    component: JsonSyncWidget,
...
registry.category("fields").add("json_sync_widget", jsonField);