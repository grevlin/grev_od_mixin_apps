...
An interactive and intuitive widget for managing JSON fields in Odoo 19, built using the modern OWL JavaScript framework.
...
- ⚙️ **Seamless Odoo Integration**: Works effortlessly with Odoo 19 models using JSON fields.
...
```
<field name="json_data" widget="json_sync_widget"/>
```
...
based on Cybrosys 's (https://cybrosys.com) advanced_json_widget
